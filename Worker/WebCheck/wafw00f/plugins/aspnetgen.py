...
def is_waf(self):
    ...
    for attack in self.attacks:
        ...
        if r is None:
            return
        _, page = r
        if any(i in page for i in (
                b'This generic 403 error means that the authenticated user is not authorized to use the requested resource',
                b'request could not be understood', b'potentially dangerous request querystring')):
            detected2 = True
