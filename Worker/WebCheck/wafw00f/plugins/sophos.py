...
def is_waf(self):
    for attack in self.attacks:
        ...
        if all(i in page for i in (b'<title>Access to the requested URL was blocked',
                                   b'Access to the requested URL was blocked',
                                   b'incident was logged with the following log identifier',
                                   b'Inbound Anomaly Score Exceeded', b'Your cache administrator is')):
            return True
    return False
